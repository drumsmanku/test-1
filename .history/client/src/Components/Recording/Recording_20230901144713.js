  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.bottomBody}>
        <button className={styles.button} onClick={handleWebcamPermissions}>Get Permissions</button>
        {startWebcamButton && 
          <div>
        ...
        <button className={styles.button} onClick={handleScreenPermissions}>Get Permissions</button>
        {startScreenButton && 
          <div>
      ...
      <div style={{display:'flex', justifyContent:'space-around'}}>
        <video height={500} width={500} id="videoPlayback" controls autoplay></video>
        <video height={500} width={500} id="screenPlayback" controls autoplay></video>
      </div>
